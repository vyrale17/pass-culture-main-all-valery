...
---`,displayName:`Timeline`,filePath:`/home/runner/work/pass-culture-main-all-valery/pass-culture-main-all-valery/pro/src/ui-kit/Timeline/Timeline.tsx`,methods:[],props:{steps:{defaultValue:null,declarations:[{fileName:`pro/src/ui-kit/Timeline/Timeline.tsx`,name:`TimelineProps`}],description:`An array of timeline steps to be displayed.`,name:`steps`,parent:{fileName:`pro/src/ui-kit/Timeline/Timeline.tsx`,name:`TimelineProps`},required:!0,tags:{},type:{name:`TimelineStep[]`}}},tags:{param:`props - The props for the Timeline component.`,returns:`The rendered Timeline component.`,example:`<Timeline
  steps={[
